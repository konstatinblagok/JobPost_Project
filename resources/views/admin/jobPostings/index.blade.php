...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-JobPosting">
            <thead>
                <tr>
                    <th width="10">
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.job-postings.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
        ...
        { data: 'url', name: 'url' },
        { data: 'post_locations', name: 'post_locations.url' },
  ...
  let table = $('.datatable-JobPosting').DataTable(dtOverrideGlobals);
